 ...
 * @constructor
 *
 * @param {Object}  crawlOpts url, maxDepth, delay, pageTimeout, maxCrawlTime, crawlObservable
...
var SiteQuery = function (crawlOpts, selector, ext) {
  this.siteCrawl = crawlOpts.crawlObservable || ((new SiteCrawl(crawlOpts)).toObservable());
  this.ext = ext;
...
SiteQuery.prototype = {
  toObservable: function () {
    var self = this;
    return self.siteCrawl.SelectMany(function(crawlResult){
