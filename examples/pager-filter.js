...
var crawlOpts = {url:'http://www.google.com/search?as_epq=matrix+1..3&num=25&hl=en&as_qdr=m3',
                 depth:2,
                 delay:1000,
                 maxCrawlTime: 100000,
...
var siteQuery = new SiteQuery(crawlOpts, 'h3.r');
...
// output the img src
  console.log('Result Title', result.elem.text());
},
// on err
function(exn) {
